...
= [Vector { _reserved : 0 } , Vector { _reserved : 0 } , Vector { _reserved : 0 } , Vector { _handler : UART } , Vector { _handler : TIMER0 } ,]
; # [doc (hidden)]
pub mod interrupt { # [doc = r"Enumeration of all the interrupts."]
# [derive (Copy , Clone , Debug , PartialEq , Eq)]
# [repr (u16)]
pub enum Interrupt { # [doc = "3 - uart"]
UART = 3 , # [doc = "4 - timer0"]
TIMER0 = 4 , } # [doc = r" TryFromInterruptError"]
# [derive (Debug , Copy , Clone)]
pub struct TryFromInterruptError (()) ; impl Interrupt { # [doc = r" Attempt to convert a given value into an `Interrupt`"]
# [inline]
pub fn try_from (value : u8) -> Result < Self , TryFromInterruptError > { match value { 3 => Ok (Interrupt :: UART) , 4 => Ok (Interrupt :: TIMER0) , _ => Err (TryFromInterruptError (())) , } } } # [cfg (feature = "rt")]
# [macro_export]
...
pub const PTR : * const identifier_mem :: RegisterBlock = 0x8200_0800 as * const _ ; # [doc = r"Return the pointer to the register block"]
# [inline (always)]
...
pub const PTR : * const leds :: RegisterBlock = 0x8200_1000 as * const _ ; # [doc = r"Return the pointer to the register block"]
# [inline (always)]
...
pub const PTR : * const spiflash_core :: RegisterBlock = 0x8200_1800 as * const _ ; # [doc = r"Return the pointer to the register block"]
# [inline (always)]
...
pub const PTR : * const spiflash_phy :: RegisterBlock = 0x8200_2000 as * const _ ; # [doc = r"Return the pointer to the register block"]
# [inline (always)]
...
pub const PTR : * const uart :: RegisterBlock = 0x8200_3000 as * const _ ; # [doc = r"Return the pointer to the register block"]
# [inline (always)]
